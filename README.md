...
|------|---------|-------------|
| **Nearby** | Cercanos | Unified 3D spatial audio from all recordings within your selectable footprint (50m to 10km). Features an **Interactive Radar HUD** in the bottom corner with manual mixing support: drag your center dot to virtually navigate the soundscape. Quadratic volume rolloff and HRTF panning update based on your virtual or GPS position. Max 10 concurrent sounds. |
